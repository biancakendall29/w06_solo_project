...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        PublicLibrary library1 = new PublicLibrary("New York Public Library");
        publicLibraryRepository.save(library1);
        ...
        Book book1 = new Book("The Night Circus", "Erin Morgenstern", library1, Arrays.asList(member2));
        Book book2 = new Book("Lord of the Rings: The Fellowship of the Ring", "JRR Tolkein", library1, Arrays.asList(member2));
        ...
        Book book11 = new Book("Mao's Last Dancer", "Li Cunxin", library1, Arrays.asList(member2));
        Book book12 = new Book("Americanah", "Chimamanda Ngozi Adichie", library1, Arrays.asList(member2));
        Book book13 = new Book("A Thousand Splendid Suns", "Khaled Hosseini", library1, Arrays.asList(member2));
        Book book14 = new Book("The Secret Life of Bees", "Sue Monk Kidd", library1, Arrays.asList(member2));
        Book book15 = new Book("The Sandman", "Lars Kepler", library1, Arrays.asList(member2));
